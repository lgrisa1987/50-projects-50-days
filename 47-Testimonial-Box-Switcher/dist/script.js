...
var select = function select(el) {
  ...
  return [].slice.call(document.querySelectorAll(el));
    ...
    testimonialsContainer = select(".testimonials-container"),
    testimonial = select(".testimonial"),
    userImage = select(".user-image"),
...
var updateTestimonials = function updateTestimonials() {
  ...
  idx++;
  idx > testimonials.length - 1 && (idx = 0);
};
